...
{
	/* スクリプトバージョン */
	private const string scriptVersionString = "2.42.46";
	...
	{
		return CriFsPlugin.CRIWAREF892BA1B();
	}
	...
	{
		return CriAtomPlugin.CRIWARE8550082A();
	}
	...
	public static uint GetManaMemoryUsage()
	{
        ...
        return 0;
#else
		return CriManaPlugin.CRIWAREFE29B2F9();
#endif
	}
	...
	public static extern int CRIWARE39241274();

	[DllImport(pluginName, CallingConvention = pluginCallingConvention)]
	public static extern void criWareUnity_SetRenderingEventOffsetForMana(int offset);
	#else
	public static int CRIWARE39241274() { return GetRequiredBinaryVersionNumber(); }
